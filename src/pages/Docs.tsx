...
const roadmapItems = [
  ...
  },
  {
    ...
    status: 'completed' as const,
    icon: TrendingUp,
    features: ['Faucet System', 'DRAGON Staking', 'Multi-hop Routing'],
  },
  {
...
const builtFeatures = [
  ...
  { name: 'Price Impact Warnings', description: 'Slippage and price impact alerts', status: 'done' as const, icon: Shield },
   ...
   { name: 'Multi-hop Routing', description: 'Optimal trade routes through multiple pools', status: 'done' as const, icon: Layers },
   { name: 'Faucet System', description: 'Claim testnet tokens with cooldown', status: 'done' as const, icon: Gift },
   { name: 'DRAGON Staking', description: 'Stake DRAGON for rewards', status: 'done' as const, icon: Lock },
   { name: 'Send/Transfer', description: 'Transfer tokens to any address', status: 'done' as const, icon: Coins },
