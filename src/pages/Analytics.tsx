    ...
    <div className="container mx-auto px-4 py-8 relative">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Real-time protocol statistics and metrics</p>
        </div>
          ...
          >
            ...
            <div className="h-48 flex items-end gap-2">
              {chartData.map((value, i) => (
                ...
                >
                  <div className="absolute -top-8 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity bg-popover px-2 py-1 rounded text-xs whitespace-nowrap">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border">
                  ...
                  <th className="text-right py-3 px-4 text-sm font-medium text-muted-foreground">TVL</th>
                  <th className="text-right py-3 px-4 text-sm font-medium text-muted-foreground">24h Volume</th>
                  <th className="text-right py-3 px-4 text-sm font-medium text-muted-foreground">APY</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} className="border-b border-border/50 hover:bg-muted/30 transition-colors">
                    ...
                    <td className="py-3 px-4">
                      <span className="font-medium">{row.pool}</span>
                    </td>
                    <td className="py-3 px-4 text-right text-sm">{row.tvl}</td>
                    <td className="py-3 px-4 text-right text-sm">{row.volume}</td>
                    <td className="py-3 px-4 text-right text-sm text-success font-medium">{row.apy}</td>
                  </tr>
                ))}
              </tbody>
            </table>
